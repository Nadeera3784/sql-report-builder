                ...
                <div className="p-4 w-full">
                    <nav className="space-y-1">
                       ...
                       <a href="#" className="flex items-center space-x-3 px-3 font-medium rounded text-white text-gray-600 hover:text-gray-700 hover:bg-gray-100 active:bg-gray-50">
                        ...
                        <a href="#" className="flex items-center space-x-3 px-3 font-medium rounded text-white text-gray-600 hover:text-gray-700 hover:bg-gray-100 active:bg-gray-50">
                            <span className="flex-none flex items-center opacity-50">
                              <svg className="hi-outline hi-presentation-chart-line inline-block w-5 h-5" stroke="currentColor" fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z"/></svg>
                            </span>
